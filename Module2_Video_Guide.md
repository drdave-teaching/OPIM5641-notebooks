...
:::note
**Recorded 2026-08-04.** Eight videos are in the can - titles below match what's in Kaltura (tagged `(BDM_hybrid)`). Transcripts and polished scripts live in `opim5641-transcripts/hybrid_fall2026/async2_module2/`.
:::
