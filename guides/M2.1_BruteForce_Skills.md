# M2.1 Skills Sheet — Brute Force Optimization

**OPIM 5641 - Business Decision Modeling · Dr. Dave Wanik · University of Connecticut**

Module 1 taught you to explore data and simulate what you don't have. This is where you start **deciding**. Check yourself off - if one feels shaky, the notebook to revisit is named right there.
...
*Companions: [Video Guide](M2.1_BruteForce_Video_Guide.md) · [Talking Points](M2.1_BruteForce_Talking_Points.md).*
