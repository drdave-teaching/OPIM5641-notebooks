# M2.1 Video Guide — Brute Force Optimization

**OPIM 5641 - Business Decision Modeling · Dr. Dave Wanik · University of Connecticut**

Module 1 ended with *"when you have data you explore it; when you don't, you simulate it."* M2.1 adds the third verb: **when you have to decide, you optimize.** This is brute force - the dumbest, most honest optimization method there is, and the one that makes you *want* the smarter methods coming next.

Watch in order; each video drives one stretch of its notebook.
...
*Companions: [Skills](M2.1_BruteForce_Skills.md) · [Talking Points](M2.1_BruteForce_Talking_Points.md). Next up: [M2.2 The Graphical Method](M2.2_Graphical_Video_Guide.md).*
